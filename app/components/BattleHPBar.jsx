 ...
 */
export default function BattleHPBar({ pokemon, currentHP, maxHP, isPlayer = false }) {
  ...
  return (
    <div className={`w-full ${isPlayer ? 'bg-blue-100' : 'bg-red-100'} border-2 border-gray-800 rounded p-2`}>
